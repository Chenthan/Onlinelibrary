...
def subscript(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            subReader=reader(RName=name,RNumber=number,Gender=gender,City=city,ContactNumber=phNo,Subscription=subscription,Charges=charges)
            subReader.save()
